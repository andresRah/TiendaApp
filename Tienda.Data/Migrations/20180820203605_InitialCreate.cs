        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(nullable: true),
                    VisitingDays = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuySale = table.Column<decimal>(nullable: false),
                    CategoryId = table.Column<int>(nullable: false),
                    CreateTime = table.Column<DateTime>(nullable: false),
                    UpdateTime = table.Column<DateTime>(nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTotalUnitPrice = table.Column<decimal>(nullable: false),
                    Iva = table.Column<decimal>(nullable: false),
                    TotalUnitPrice = table.Column<decimal>(nullable: false),
                    ProductId = table.Column<int>(nullable: false),
                    SalesId = table.Column<int>(nullable: false),
                    CreateTime = table.Column<DateTime>(nullable: false),
                    UpdateTime = table.Column<DateTime>(nullable: false)
