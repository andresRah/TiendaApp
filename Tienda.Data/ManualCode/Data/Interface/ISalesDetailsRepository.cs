namespace Tienda.Data.ManualCode.Data.Interface
{
    ...
    /// <summary>
    /// Repositorio para acceder a la entidad: SalesDetails (SalesDetails)
    /// </summary>
    public partial interface ISalesDetailsRepository
    {
        /// <summary>
        ...
        IQueryable<SalesDetails> GetAll();

        /// <summary>
        /// Metodo que devuelve una colección de entidades  SalesDetails (SalesDetails) que cumplen con el predicado pasado por parametro
        /// </summary>
        ...
        IQueryable<SalesDetails> Where(Expression<Func<SalesDetails, bool>> predicate);

        /// <summary>
        /// Metodo que permite insertar una nueva entidad: SalesDetails (SalesDetails)
        /// </summary>
        ...
        SalesDetails Insert(SalesDetails entity, string user);
        ...
        void Update(SalesDetails entity, string user);
        ...
        SalesDetails GetWithInclude<T>(int id, params Expression<Func<SalesDetails, object>>[] associations) where T : class;
        ...
        IQueryable<SalesDetails> IncludeMultiple<T>(params Expression<Func<SalesDetails, object>>[] associations) where T : class;
