namespace Tienda.Data.ManualCode.Data.Interface
{
    ...
    /// <summary>
    /// Repositorio para acceder a la entidad: Invoice (Invoice)
    /// </summary>
    public partial interface IInvoiceRepository
    {
        ...
        /// <summary>
        /// Metodo que devuelve una colección de entidades  Invoice (Invoice) que cumplen con el predicado pasado por parametro
        /// </summary>
        ...
        IQueryable<Invoice> Where(Expression<Func<Invoice, bool>> predicate);

        /// <summary>
        /// Metodo que permite insertar una nueva entidad: Invoice (Invoice)
        /// </summary>
        ...
        Invoice Insert(Invoice entity, string user);
        ...
        void Update(Invoice entity, string user);
        ...
        Invoice GetWithInclude<T>(int id, params Expression<Func<Invoice, object>>[] associations) where T : class;
        ...
        IQueryable<Invoice> IncludeMultiple<T>(params Expression<Func<Invoice, object>>[] associations) where T : class;
