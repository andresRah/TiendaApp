namespace Tienda.Services.ManualCode.Class
{
    ...
    public partial class CategoryServices : ICategoryServices, IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Repositorio que permite el acceso a las entidades: Category (Category)
        /// </summary>
        ...
        /// Repositorio que permite el acceso a las entidades: Category (Category)
        /// </summary>
        partial void SetEntityExtras(ref Category entity, CategoryDTO dto);
        ...
        /// <summary>
        /// Metodo para extender el Constructor para los servicios de la entidad: Category (Category)
		/// </summary>
        ...
        public CategoryDTO Get(int id)
        {
            ...
            {
                Category entity = _repository.Get(id);
                return GetDTO(entity);
            }
        }

        /// <summary>
        /// Obtiene todos los registros de Categorys realizando filtros mediante la URL
        /// </summary>
        public virtual DataSourceResult GetAll(DataSourceRequest request)
        {
            using (this._dbContextScopeFactory)
            {
                ...
                .Select(o => new CategoryDTO()).ToDataSourceResult(request);
            }
        }

        /// <summary>
        /// Servicio que permite insertar una nueva entidad: Category (Category)
        /// </summary>
		...
		public CategoryDTO Insert(CategoryDTO dto, string user)
        {
            using (var dbContextScope = new TiendaDbContext())
            {
                Category entity = GetEntity(dto);
        ...
        /// <summary>
        /// Actualiza un Category por medio del id
        /// </summary>
        public void Update(string id, CategoryDTO entity)
        {
            using (var dbContextScope = new TiendaDbContext())
            {
        ...
        /// <summary>
        /// Servicio que elimina una entidad Category (Category) dado su Id
        /// </summary>
        ...
        /// <summary>
        /// Servicio que devuelve una colección de DTOs para las entidades  Category (Category) que cumplen con el predicado pasado por parametro
        /// </summary>
		...
		public virtual IEnumerable<CategoryDTO> Where(Expression<Func<Category, bool>> predicate)
        {
            using (_dbContextScopeFactory)
            {
        ...
        /// </summary>
        public IEnumerable<CategoryDTO> GetCategoryByDate(string Ciudad, DateTime FechaInicial, DateTime FechaFinal)
        {
            using (_dbContextScopeFactory)
            {
                var Categorys = _repository.Where(o => o.CreateTime >= FechaInicial &&
        ...
        private Category GetEntity(CategoryDTO dto)
        {
            using (_dbContextScopeFactory)
            {
                ...
                if (dto.CategoryId > 0)
                {
                    entity = _repository.Get(dto.CategoryId);
                }
                if (entity == null)
                {
                    entity = new Category();
		...
		private CategoryDTO GetDTO(Category entity)
        {
        ...
        partial void SetDTOExtras(Category entity, ref CategoryDTO dto);
