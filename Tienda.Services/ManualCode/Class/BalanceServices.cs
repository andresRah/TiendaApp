namespace Tienda.Services.ManualCode.Class
{
    ...
    public partial class BalanceServices : IBalanceServices, IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Repositorio que permite el acceso a las entidades: Balance (Balance)
        /// </summary>
        static IBalanceRepository _repository;
        ...
        /// Repositorio que permite el acceso a las entidades: Balance (Balance)
        /// </summary>
        partial void SetEntityExtras(ref Balance entity, BalanceDTO dto);
        ...
        /// <summary>
        /// Metodo para extender el Constructor para los servicios de la entidad: Balance (Balance)
		/// </summary>
        ...
        public BalanceDTO Get(int id)
        {
            ...
            {
                Balance entity = _repository.Get(id);
                return GetDTO(entity);
            }
        }

        /// <summary>
        /// Obtiene todos los registros de Balances realizando filtros mediante la URL
        /// </summary>
        public virtual DataSourceResult GetAll(DataSourceRequest request)
        {
            using (this._dbContextScopeFactory)
            {
                ...
                .Select(o => new BalanceDTO()).ToDataSourceResult(request);
            }
        }
        ...
        /// <summary>
        /// Servicio que elimina una entidad Balance (Balance) dado su Id
        /// </summary>
        ...
        /// <summary>
        /// Servicio que devuelve una colección de DTOs para las entidades  Balance (Balance) que cumplen con el predicado pasado por parametro
        /// </summary>
		...
		public virtual IEnumerable<BalanceDTO> Where(Expression<Func<Balance, bool>> predicate)
        {
            using (_dbContextScopeFactory)
            {
                return _repository.Where(predicate)
                            .Select(o => new BalanceDTO()
                            {
        ...
        /// </summary>
        public IEnumerable<BalanceDTO> GetBalanceByDate(string Ciudad, DateTime FechaInicial, DateTime FechaFinal)
        {
            using (_dbContextScopeFactory)
            {
                var Balances = _repository.Where(o => o.CreateTime >= FechaInicial &&
        ...
        private Balance GetEntity(BalanceDTO dto)
        {
            using (_dbContextScopeFactory)
            {
                Balance entity = null;
                if (dto.BalanceId > 0)
                {
                    entity = _repository.Get(dto.BalanceId);
                }
                if (entity == null)
                {
                    entity = new Balance();
                }
                entity.BalanceId = dto.BalanceId;
        ...
        partial void SetDTOExtras(Balance entity, ref BalanceDTO dto);
